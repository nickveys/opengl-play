...
/** \ingroup regression
  ...
  * Thus, we get \f$a=0.495, b = -1.927, c = -2.906\f$. Let us check that for
...
inline void linearRegression( int numPoints,
                              ...
                              int funcOfOthers )
{
    linearRegressionBase< T, Vector<T,Size>, Matrix<T,Size> >
...
{
    computeFittingHyperplaneBase< T, Vector<T,Size>, Vector<T,Size+1>,
                                     Matrix<T,Size> >
...
inline void linearRegressionX( int numPoints,
                              ...
                              int funcOfOthers )
{
    linearRegressionBase< T, VectorX<T>, MatrixX<T> >
                        ( numPoints, points, retCoefficients, funcOfOthers );
}
...
inline void computeFittingHyperplaneX( int numPoints,
                                      ...
                                      VectorX<T> * retCoefficients )
{
    computeFittingHyperplaneBase< T, VectorX<T>, VectorX<T>, MatrixX<T> >
                        ( numPoints, points, retCoefficients );
}
