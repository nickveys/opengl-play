...
/** \ingroup fixedsize
  ...
  * @code
    ...
    Vector3d vec1(array1); // construct vector vec1 from array array1

    Vector3d vec2; // construct a new uninitialized vector of size 3
...
private:
    ...
    /** \internal
      ...
      */
    inline bool _hasDynamicSize() const
    { return false; }
    ...
    /** \internal
      ...
      */
    inline void _resize( int size ) const
    { EIGEN_ASSERT_NOABORT( size == this->size() ); }

public:

    /**
      * Default constructor. Constructs a vector with unitialized coords.
      */
    inline Vector() {}
    ...
    /**
      ...
      */
    inline Vector( int unused_size )
    { EIGEN_ASSERT_NOABORT( unused_size == this->size() ); }
    ...
    /**
      ...
      * The unused_size argument is not used.
      */
    inline Vector( int unused_size, const T *array )
    {
        EIGEN_ASSERT_NOABORT( unused_size == this->size() );
        readArray( array );
    }
    ...
    {
        EIGEN_ASSERT_NOABORT( this->size() == 2 );
        this->x() = x;
        this->y() = y;
    }
    ...
    {
        EIGEN_ASSERT_NOABORT( this->size() == 3 );
        this->x() = x;
        this->y() = y;
        this->z() = z;
    }
    ...
    {
        EIGEN_ASSERT_NOABORT( this->size() == 4 );
        this->x() = x;
        this->y() = y;
        this->z() = z;
        this->w() = w;
...
public:
    ...
    /** \hide */
    inline VectorX & operator = ( const VectorX & other )
    { return Base::operator = ( other ); }
    ...
    inline VectorX & operator *=( const T & factor )
    { return Base::operator *= ( factor ); }
